...
class Plugin {
    ...
    public static function init(){
        ...
        // ── AJAX: Handler registrieren (für eingeloggte + Gäste)
        // Datei liegt in includes/class-campx-ajax.php
        if ( file_exists( __DIR__ . '/class-campx-ajax.php' ) ) {
            require_once __DIR__ . '/class-campx-ajax.php';
            \CampX\Ajax::init();
        }

        // ── CPT / Admin / Frontend / REST / ICS
